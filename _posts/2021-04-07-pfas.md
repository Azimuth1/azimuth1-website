...
| Dimension | 10th | 25th | 50th | 75th | 90th | 95th | 99th |
|--|--|--|--|--|--|--|--|
...
As seen in Figure 6 and Table 4, the peak of PFAS plume length is more than 3.5 times that of DNAPL plume lengths for each data subset’s respective kernel density plots.
...
As seen in Figure 8 and Table 6, the peak of PFAS plume widths is more than 3 times that of DNAPL plume widths for each data subset’s respective kernel density plots.
...
|Dimension|R-squared|P-value of the F-statistic|
|--|--|--|
